...
class AbhishekFeatures(FoldIndependent, luigi.Task):
    ...
    def run(self):
        ...
        train_data.to_msgpack('cache/abhishek/dataset/train.msg')
        ...
        test_data.to_msgpack('cache/abhishek/dataset/test.msg')

    def _load_test(self):
        return pandas.read_msgpack('cache/abhishek/dataset/test.msg')

    def _load(self):
        data = pandas.read_msgpack('cache/abhishek/dataset/train.msg')
